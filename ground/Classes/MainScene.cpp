...
bool MainScene::init() {
	...
	lbaseStick = JoystickSkin::create();
	ljoypad = Joystick::create(D_LEFT);
	...
	// Manually tweaked the joystick position
	...
	rbaseStick = JoystickSkin::create();
	rjoypad = Joystick::create(D_RIGHT);
